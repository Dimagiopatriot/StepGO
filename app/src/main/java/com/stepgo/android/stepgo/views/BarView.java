...
import com.stepgo.android.stepgo.utils.MyUtils;
...
public class BarView extends View {
    ...
    private final int TEXT_COLOR = getResources().getColor(R.color.colorText);
    private final int BACKGROUND_COLOR = getResources().getColor(R.color.colorBackground);
    private final int FOREGROUND_COLOR = getResources().getColor(R.color.colorPrimaryDark);
